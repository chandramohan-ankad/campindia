...
$(document).ready(function() {
	...
	$(addActivity).click(function(e) {
		e.preventDefault();
		if (x < max) {
			$(activitywrapper).append(
				'<div><input type="text" name="activity[]" placeholder="activity" class="form-control"><a href="#" class="remove">Remove</a></div>'
			);
			x++;
		}
	});
	...
	$(addService).click(function(e) {
		...
		if (y < max) {
			$(servicewrapper).append(
				'<div><input type="text" name="service[]" placeholder="service" class="form-control"><a href="#" class="remove">Remove</a></div>'
			);
			y++;
		}
	});
